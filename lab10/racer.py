...
bg = pygame.image.load("C:/Users/akonp/Desktop/pp2/racer.png")
DISPLAYSURF = pygame.display.set_mode((840,650))
DISPLAYSURF.fill(WHITE)
pygame.display.set_caption("Racer")
font = pygame.font.Font(":/Users/akonp/Desktop/pp2/Lato-Black.ttf", 60)
font_small = pygame.font.Font(":/Users/akonp/Desktop/pp2/Lato-Black.ttf", 40)
...
class Coin(pygame.sprite.Sprite):
    ...
    def __init__(self, weight):
        ...
        self.weight = weight
        if self.weight == 3:
            self.image = pygame.image.load(":/Users/akonp/Desktop/pp2/coin_gold_racer.png")
        elif self.weight == 2:
            self.image = pygame.image.load(":/Users/akonp/Desktop/pp2/coin_silver_racer.png")
        else:
            self.image = pygame.image.load(":/Users/akonp/Desktop/pp2/coin_bronze_racer.png")
...
class Enemy(pygame.sprite.Sprite):
      ...
      def __init__(self):
        super().__init__() 
        self.image = pygame.image.load(":/Users/akonp/Desktop/pp2/Enemy.png")
        self.rect = self.image.get_rect()
        self.rect.center=(random.randint(200,SCREEN_WIDTH-200),0) 
...
class Player(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__() 
        self.image = pygame.image.load(":/Users/akonp/Desktop/pp2/Player.png")
        self.rect = self.image.get_rect()
